...
const Alerts = () => (
  <>
    <Row className='margin-bottom'>
      ...
      <Heading type={2} className='gray' text='Info' />
    ...
    <Row className='margin-bottom'>
      ...
      <Heading type={2} className='gray' text='Error' />
    ...
    <Row className='margin-bottom'>
      ...
      <Heading type={2} className='gray' text='Warning' />
    ...
    <Row className='margin-bottom'>
      ...
      <Heading type={2} className='gray' text='Success' />
