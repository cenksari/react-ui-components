...
const Paginations = () => (
  <>
    <Row className='margin-bottom'>
      ...
      <Pagination url='/' prev={1} next={2} pageSize={30} totalRows={200} currentPage={1} />
      <code>
        &lt;Pagination url=&apos;/&apos; prev={'{1}'} next={'{2}'} pageSize={'{30}'} totalRows=
        {'{200}'} currentPage={'{1}'} /&gt;
      </code>
    </Row>
    <Row className='margin-bottom'>
      ...
      <Pagination url='/' prev={1} next={2} pageSize={30} totalRows={2000} currentPage={1} />
      <code>
        &lt;Pagination url=&apos;/&apos; prev={'{1}'} next={'{2}'} pageSize={'{30}'} totalRows=
        {'{2000}'} currentPage={'{1}'} /&gt;
      </code>
